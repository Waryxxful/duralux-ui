 ...
 */
export function Alert({ variant = 'primary', soft = false, icon, dismissible, onDismiss, title, children, className = '' }) {
  ...
  return (
    <div className={cx('alert', toneClass, 'd-flex align-items-center gap-3', closable && 'alert-dismissible', className)} role="alert">
      {icon && (
